...
const TYPE_IMAGES: Record<PropertyType, string[]> = {
  "Flat / Apartment": listingPhotos("apartment"),
  Villa: listingPhotos("villa"),
  Penthouse: listingPhotos("penthouse"),
  "Independent House": listingPhotos("house"),
  "Commercial Building": listingPhotos("commercial"),
  Shop: listingPhotos("shop"),
  "PG / Co-living Building": listingPhotos("pg"),
  "Farm / Farmhouse": listingPhotos("farm"),
  "Plot / Land": listingPhotos("plot"),
};
